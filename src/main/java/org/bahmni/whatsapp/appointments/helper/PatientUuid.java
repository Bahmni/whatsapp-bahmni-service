...
public class PatientUuid {
    @Autowired
    OpenmrsLoginImpl openmrsLogin = new OpenmrsLoginImpl();

    public String fetchPatientUuid(String patientId) throws IOException {
        ...
        String patientUuid = responseObject.getJSONArray("entry").getJSONObject(0).getJSONObject("resource").getString("id");
